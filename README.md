...
```bash
$ git clone https://github.com/arjunkhetia/Node.Js-Express-Oracle-Project.git
```
...
![Monitoring Page](https://github.com/arjunkhetia/Node.Js-Express-Oracle-Project/blob/master/public/status-monitor.png "Monitoring Page")
